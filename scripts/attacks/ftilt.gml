...
set_window_value(AT_FTILT, 3, AG_WINDOW_LENGTH, 21);
...
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 34);
set_hitbox_value(AT_FTILT, 1, HG_BASE_KNOCKBACK, 4.7); //47
set_hitbox_value(AT_FTILT, 1, HG_KNOCKBACK_SCALING, 1.04); //104
...
set_hitbox_value(AT_FTILT, 2, HG_ANGLE, 34);
set_hitbox_value(AT_FTILT, 2, HG_BASE_KNOCKBACK, 4.7); //47
set_hitbox_value(AT_FTILT, 2, HG_KNOCKBACK_SCALING, 1.04); //104
