...
set_hitbox_value(AT_USTRONG, 1, HG_DAMAGE, 19);
set_hitbox_value(AT_USTRONG, 1, HG_ANGLE, 90);
set_hitbox_value(AT_USTRONG, 1, HG_BASE_KNOCKBACK, 6.5); //65
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, .62); // 62
set_hitbox_value(AT_USTRONG, 1, HG_BASE_HITPAUSE, 12); // 8
...
set_hitbox_value(AT_USTRONG, 2, HG_BASE_KNOCKBACK, 6.5); //65
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, .62); // 62
