...
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_Y, -30); // -40
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 64); // 65
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 64); // 65
...
set_hitbox_value(AT_NAIR, 2, HG_WINDOW_CREATION_FRAME, 3); // 6
set_hitbox_value(AT_NAIR, 2, HG_LIFETIME, 3);
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_Y, -30); // -40
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_GROUP, 1);

set_hitbox_value(AT_NAIR, 3, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NAIR, 3, HG_WINDOW, 2);
set_hitbox_value(AT_NAIR, 3, HG_WINDOW_CREATION_FRAME, 6); // 12
set_hitbox_value(AT_NAIR, 3, HG_LIFETIME, 4); // 3
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_Y, -30); // -40
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 72); // 70
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 72); // 70
set_hitbox_value(AT_NAIR, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_NAIR, 3, HG_DAMAGE, 2); // 5
set_hitbox_value(AT_NAIR, 3, HG_ANGLE, 70);
set_hitbox_value(AT_NAIR, 3, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, .4); // 2
