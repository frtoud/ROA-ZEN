...
set_hitbox_value(AT_NAIR, 1, HG_DAMAGE, 13);
set_hitbox_value(AT_NAIR, 1, HG_ANGLE, 45);
set_hitbox_value(AT_NAIR, 1, HG_BASE_KNOCKBACK, 4.2); //42
set_hitbox_value(AT_NAIR, 1, HG_KNOCKBACK_SCALING, .64); //64
...
set_hitbox_value(AT_NAIR, 2, HG_HEIGHT, 46);
set_hitbox_value(AT_NAIR, 2, HG_PRIORITY, 1);
set_hitbox_value(AT_NAIR, 2, HG_DAMAGE, 10);
set_hitbox_value(AT_NAIR, 2, HG_ANGLE, 45);
set_hitbox_value(AT_NAIR, 2, HG_BASE_KNOCKBACK, 4.2); //42
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, .59); //59
