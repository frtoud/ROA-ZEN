...
//"5LL"
set_window_value(AT_JAB, 4, AG_WINDOW_LENGTH, 11);
...
set_window_value(AT_JAB, 8, AG_WINDOW_VSPEED, -7);

set_window_value(AT_JAB, 9, AG_WINDOW_LENGTH, 17);
set_window_value(AT_JAB, 9, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_JAB, 9, AG_WINDOW_ANIM_FRAME_START, 2);
...
set_hitbox_value(AT_JAB, 3, HG_HEIGHT, 95);
