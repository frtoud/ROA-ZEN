...
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_KNOCKBACK, 2.6); //26
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 0.98); //98
...
set_hitbox_value(AT_FSTRONG, 2, HG_BASE_KNOCKBACK, 2.6); //26
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, 0.98); //98
