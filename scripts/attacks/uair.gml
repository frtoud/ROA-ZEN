...
set_hitbox_value(AT_UAIR, 1, HG_BASE_KNOCKBACK, 3); //30
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, 1.1); //110
...
set_hitbox_value(AT_UAIR, 2, HG_BASE_KNOCKBACK, 3); //30
set_hitbox_value(AT_UAIR, 2, HG_KNOCKBACK_SCALING, 1.1); //110
